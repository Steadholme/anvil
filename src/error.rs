...
//! keystone/inkwell/loom error seam.
...
#[derive(Debug, Error)]
pub enum AppError {
    /// Malformed/incomplete form input (empty name, missing repo URL, etc.).
...
/// Store failures collapse to their HTTP shape: a duplicate id is a 409-ish conflict surfaced as a
/// bad request, everything else 500.
